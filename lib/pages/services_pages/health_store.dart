...
class HealthStore extends StatefulWidget {
  const HealthStore({super.key});

  @override
  State<HealthStore> createState() => _HealthStoreState();
}

class _HealthStoreState extends State<HealthStore> {
  List<String> images = [
...
// 1st row
              ...
              Row(mainAxisAlignment: MainAxisAlignment.spaceEvenly, children: <
                ...
                //   Navigator.push(context,
                //       // MaterialPageRoute(builder: (context) => finddoctor()));
                //       MaterialPageRoute(builder: (context) => https://dawaai.pk/));
                // },
